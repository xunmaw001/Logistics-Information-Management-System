	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","margin":"12px 0 0","background":"none","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #7e7a59;
				  				  white-space: nowrap;
				  				  background: linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 66%, rgba(232,230,212,1) 90%, rgba(208,205,176,1) 100%);
				  				  border-color: #b1ae90;
