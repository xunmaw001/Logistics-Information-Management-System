	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 0","background":"url(http://codegen.caihongy.cn/20230328/e3b3ef59d7a44ae6afcff886f7a76b98.jpg) no-repeat center bottom / 100% 100%","height":"auto"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="入库类型" prop="rukuleixing">
					<el-select :disabled="ro.rukuleixing" v-model="ruleForm.rukuleixing" placeholder="请选择入库类型" >
						<el-option
							v-for="(item,index) in rukuleixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="入库类型" prop="rukuleixing">
					<el-input v-model="ruleForm.rukuleixing"
						placeholder="入库类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="供应商" prop="gongyingshang">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="供应商" prop="gongyingshang">
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='rukuleixing'){
							this.ruleForm.rukuleixing = obj[o];
							this.ro.rukuleixing = true;
							continue;
						}
						if(o=='guige'){
            ...
            this.$http({
				url: `option/gongyingshang/gongyingshang`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
