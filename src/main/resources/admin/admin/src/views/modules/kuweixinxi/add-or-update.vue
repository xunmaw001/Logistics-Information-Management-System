<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 0","background":"url(http://codegen.caihongy.cn/20230328/e3b3ef59d7a44ae6afcff886f7a76b98.jpg) no-repeat center bottom / 100% 100%","height":"auto"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="仓库编号" prop="cangkubianhao">
					<el-input v-model="ruleForm.cangkubianhao" placeholder="仓库编号" clearable  :readonly="ro.cangkubianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="仓库编号" prop="cangkubianhao">
					<el-input v-model="ruleForm.cangkubianhao" placeholder="仓库编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="仓库位置" prop="cangkuweizhi">
					<el-input v-model="ruleForm.cangkuweizhi" placeholder="仓库位置" clearable  :readonly="ro.cangkuweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="仓库位置" prop="cangkuweizhi">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kuweixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kuweixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
